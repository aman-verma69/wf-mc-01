...
export default function Home() {
  const [messages, setMessages] = useState<Message[]>([{role:"agent",text:"Hi! Tell me what you are looking for. I can understand natural requests, compare options, manage your cart, and securely checkout when you are ready."}]);
